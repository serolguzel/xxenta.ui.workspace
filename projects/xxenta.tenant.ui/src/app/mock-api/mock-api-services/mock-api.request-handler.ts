...
import { GenesisMockApiReplyCallback } from './mock-api.types';

export class GenesisMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: GenesisMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: GenesisMockApiReplyCallback): void
    {
        // Store the reply
