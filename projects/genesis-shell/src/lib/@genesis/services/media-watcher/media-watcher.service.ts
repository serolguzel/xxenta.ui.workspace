...
import { GenesisConfigService } from '../config/config.service';

@Injectable({providedIn: 'root'})
export class GenesisMediaWatcherService
{
    ...
    constructor(
        ...
        private _genesisConfigService: GenesisConfigService,
    )
    {
        this._genesisConfigService.config$.pipe(
