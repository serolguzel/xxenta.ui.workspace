...
import { GenesisVerticalNavigationGroupItemComponent } from '../group/group.component';
import { GenesisVerticalNavigationSpacerItemComponent } from '../spacer/spacer.component';

@Component({
  selector: 'genesis-vertical-navigation-aside-item',
...
export class GenesisVerticalNavigationAsideItemComponent implements OnChanges, OnInit, OnDestroy {
